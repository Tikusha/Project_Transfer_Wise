...
class LogInViewController: UIViewController {
    ...
    private func configuration() {
        ...
        self.googleButton.customCorner(cornerRadius: 2, borderWidth: 0.5, borderColor: Constants.Color.blue)
        self.faceButton.customCorner(cornerRadius: 2, borderWidth: 0.5, borderColor: Constants.Color.blue)
        self.appleButton.customCorner(cornerRadius: 2, borderWidth: 0.5, borderColor: Constants.Color.blue)
    }
